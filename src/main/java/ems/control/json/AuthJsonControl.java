...
public class AuthJsonControl {
  ...
  public AjaxResult login(String email, String password, String facebook, String kakao, String naver,
      HttpServletResponse response, HttpSession session, Model model) throws Exception {
    
    Member member = authService.getMemberInfo(email, password, facebook, kakao, naver);
