...
values(1,1,'시티즌 시계','패션','2016-01-01',30,'택배','시티즌 시계 입니다. 정품, 새제품이고 택, 내부구성품, 박스 그대로 입니다','2017-03-27 21:13',70000);
...
구성품 노트북 + 아답터' ,'2017-03-27 21:13' + interval 3 minute,100000);
...
카프스킨가방의 최고봉으로 편리함과 럭셔리함을 더한 샤넬 명품중의 명품 샤넬 카프스킨 블랙 COCO 은장로고 서프 토드백 겸 숄더스트랩 2WAY백 입니다.', '2017-03-27 21:13' + interval 6 minute, 300000);
...
기본구성품(일반낙찰시제공)
1.캐논 700D 바디 2.탐론 18-200mm 렌즈(후드제외) 3.배터리 4.충전기 5.스트랩(어깨끈) 6.바디캡 7.렌즈보호캡 8.USB연결잭 9.외부영상연결잭 10.캐논카달로그 11.정품보증서 12.사용설명서 13.소프트웨어CD 14.4GB메모리','2017-03-27 21:13' + interval 9 minute,300000);
...
사용법은 닥터데스크 홈페이지의 http://doctordesk.co.kr/board/free/read.html?no=23&board_no=1에 나와 있습니다.','2017-03-27 21:13' + interval 12 minute, 30000);
...
직거래는 경기도 지역에서 가능합니다.','2017-03-27 21:13' + interval 15 minute,20000);
...
되도록이면 부산 인근에서 사시는분들과 직 거래를 우선합니다.','2017-03-27 21:13' + interval 18 minute,450000);
...
가로16.5 세로24 폭15 입니다
전체 적으로 상태 좋습니다.
중고 특성상 반품 불가입니다','2017-03-27 21:13' + interval 21 minute,30000);
...
필요하신분 입찰부탁드려요~','2017-03-27 21:13' + interval 24 minute,30000);
