...
--관심 데이터
insert into inter(mno,itno,type,rdt) values(1,2,2,'2017-01-01');
insert into inter(mno,itno,type,rdt) values(2,3,2,'2017-01-01');
insert into inter(mno,itno,type,rdt) values(3,4,2,'2017-01-01');
insert into inter(mno,itno,type,rdt) values(2,4,2,'2017-01-01');
insert into inter(mno,itno,type,rdt) values(4,5,2,'2017-01-01');
insert into inter(mno,itno,type,rdt) values(4,6,2,'2017-01-01');
insert into inter(mno,itno,type,rdt) values(2,8,2,'2017-01-01');
...
insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(10,1,'시티즌 시계','패션','2016-01-01',30,'택배','시티즌 시계 입니다. 정품, 새제품이고 택, 내부구성품, 박스 그대로 입니다',now() + interval 270 minute,70000);

insert into phot(pno,itno,path) values(37,10,'1487897161498_24');
insert into phot(pno,itno,path) values(38,10,'1487897161498_25');
insert into phot(pno,itno,path) values(39,10,'1487897161498_26');
insert into phot(pno,itno,path) values(40,10,'1487897161498_27');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(11,2,'HP파빌리온G7','디지털','2016-02-21',100,'택배','HP 파빌리온G7
...
본제품 HP 파빌리온G7 노트북입니다. 대화면노트북으로 제품상태 깨끗하며 사무작업 인터넷쇼핑 영화감상등 기본적인사용과 고사양 게임들도 원활합니다. 배터리 완충시 평균3시간 내외 사용가능합니다. 사용하실프로그램 권장사양비교후 신중한 입찰 부탁드립니다. 낙찰가에 보내드리며 착불3000원입니다. 좋은거래 부탁드립니다. 감사합니다.
구성품 노트북 + 아답터' ,now() + interval 300 minute,100000);

insert into phot(pno,itno,path) values(41,11,'1487897579286_28');
insert into phot(pno,itno,path) values(42,11,'1487897579287_29');
insert into phot(pno,itno,path) values(43,11,'1487897579287_30');
insert into phot(pno,itno,path) values(44,11,'1487897579288_31');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(12,3,'샤넬 토드백 겸 숄더','패션','2016-12-01',now() + interval 300 minute,'택배','샤넬(CHANEL) 카프스킨 블랙 COCO 은장로고 서프 토드백 겸 숄더스트랩 2WAY
...
설명이 더이상 필요없는 명품 가방의 대명사 샤넬 카프스킨 블랙 COCO 은장로고 서프 토드백 겸 숄더스트랩 2WAY백 입니다~
엄선한 프랑스산 송아지 가죽을 샤넬만의 특유의 기술로 정밀가공하여 숙련된 프랑스 장인들의 꼼꼼한 솜씨로 한땀 한땀 정성을 다해 제작한 명품 샤넬 카프스킨 블랙 COCO 은장로고 서프 토드백 겸 숄더스트랩 2WAY백 입니다~
카프스킨가방의 최고봉으로 편리함과 럭셔리함을 더한 샤넬 명품중의 명품 샤넬 카프스킨 블랙 COCO 은장로고 서프 토드백 겸 숄더스트랩 2WAY백 입니다.', now() + interval 330 minute, 300000);

insert into phot(pno,itno,path) values(45,12,'1487898025542_32');
insert into phot(pno,itno,path) values(46,12,'1487898025543_33');
insert into phot(pno,itno,path) values(47,12,'1487898025543_34');
insert into phot(pno,itno,path) values(48,12,'1487898025544_35');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(13,4,'캐논 정품 EOS-700D','디지털','2016-03-21',15,'택배','본제품은 캐논 정품이며 무상A/S가능한제품입니다.
액정회전식으로 셀프카메라촬영이가능하며 동영상촬영이가능합니다.
낙찰시 아래에명시한 기본구성품이발송되며 즉시구매시 10만원상당의 32GB풀패키지구성으로 발송해드리는 행사를진행하고있습니다.
DSLR 카메라세트의경우 본체 바디보다 렌즈에따라 가격이 천차만별입니다.
풀 HD동영상촬영 DSLR의경우 메모리의 용량에따라 동영상촬영시간이달라집니다.
...
렌즈하나로 렌즈3개의성능을발휘하며 화질또한 최고의결과물을 선사해주며 가격면에서도 경제적인렌즈입니다.
기본구성품(일반낙찰시제공)
1.캐논 700D 바디 2.탐론 18-200mm 렌즈(후드제외) 3.배터리 4.충전기 5.스트랩(어깨끈) 6.바디캡 7.렌즈보호캡 8.USB연결잭 9.외부영상연결잭 10.캐논카달로그 11.정품보증서 12.사용설명서 13.소프트웨어CD 14.4GB메모리',now() + interval 360 minute,300000);

insert into phot(pno,itno,path) values(49,13,'1487898434996_36');
insert into phot(pno,itno,path) values(50,13,'1487898434996_37');
insert into phot(pno,itno,path) values(51,13,'1487898434996_38');
insert into phot(pno,itno,path) values(52,13,'1487898434997_39');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(14,5,'닥터데스크 높낮이 조절 책상','가구','2016-02-01',30,'택배','안녕하세요.
닥터데스크 일반형 판매합니다.
"일.반.형" 입니다.

7개월 동안 사용했고 밑에 지지하는 고무가 잘 떨어져 글루건으로 보강해놓았습니다.
사용법은 닥터데스크 홈페이지의 http://doctordesk.co.kr/board/free/read.html?no=23&board_no=1에 나와 있습니다.',now() + interval 390 minute, 30000);

insert into phot(pno,itno,path) values(53,14,'1487898661109_40');
insert into phot(pno,itno,path) values(54,14,'1487898661110_41');
insert into phot(pno,itno,path) values(55,14,'1487898661110_42');
insert into phot(pno,itno,path) values(56,14,'1487898661111_43');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(15,2,'헥스 통기타 HONEY G240C','취미','2016-01-01',30,'택배 또는 직거래','두달전에 구입한 헥스 통기타 입니다.
튜너기,줄감개,기타 스트랩,피크2개,피크케이스,가방,통기타책3권을
같이 드립니다.전체적으로 깨끗한 상태이고 줄교체과정에서 브릿지핀에 약간의 기스가있습니다.
직거래는 경기도 지역에서 가능합니다.',now() + interval 420 minute,20000);

insert into phot(pno,itno,path) values(57,15,'1487898952886_44');
insert into phot(pno,itno,path) values(58,15,'1487898952886_45');
insert into phot(pno,itno,path) values(59,15,'1487898952887_46');
insert into phot(pno,itno,path) values(60,15,'1487898952887_47');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(16,5,'엘파마 MTB','레져','2016-01-01',30,'직거래','구매 7개월 된 MTB자전거 팝니다,
실사용은 3회이며 총 60km 정도 주행 했으며 사진처럼 새거대비 95%이상되는 제품입니다.
꼭 구매할분만 입찰해주시고 태클및 장난입찰은 정중히 사양합니다
되도록이면 부산 인근에서 사시는분들과 직 거래를 우선합니다.',now() + interval 450 minute,450000);

insert into phot(pno,itno,path) values(61,16,'1487912711572_0');
insert into phot(pno,itno,path) values(62,16,'1487912711573_1');
insert into phot(pno,itno,path) values(63,16,'1487912711573_2');
insert into phot(pno,itno,path) values(64,16,'1487912711574_3');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(17,3,'JBL 북쉘프 스피커','디지털','2016-01-01',30,'택배 또는 직거래','
JBL 노스리지 북쉘프 스피커 팝니다
돔트위터와  5인치 우퍼 조합이고
8옴입니다
사이즈는 
가로16.5 세로24 폭15 입니다
전체 적으로 상태 좋습니다.
중고 특성상 반품 불가입니다',now() + interval 480 minute,30000);

insert into phot(pno,itno,path) values(65,17,'1487912907326_4');
insert into phot(pno,itno,path) values(66,17,'1487912907326_5');
insert into phot(pno,itno,path) values(67,17,'1487912907327_6');
insert into phot(pno,itno,path) values(68,17,'1487912907327_7');

insert into item(itno,mno,titl,categ,buy,day,deal,cont,time,stpc)
values(18,5,'삼성 SSD 840 250GB','디지털','2016-01-01',30,'택배','
삼성 840 SSD 입니다.
250GB구요 본체 OS 백업용으로 들고 있어 사용시간 짧아요
필요하신분 입찰부탁드려요~',now() + interval 510 minute,30000);

insert into phot(pno,itno,path) values(69,18,'1487913225052_8');
insert into phot(pno,itno,path) values(70,18,'1487913225052_9');
insert into phot(pno,itno,path) values(71,18,'1487913225053_10');
insert into phot(pno,itno,path) values(72,18,'1487913225053_11');